...
//the method "boolean accept(File dir, String name)" tests if a specified file should be included in a file list. 
//Parameters: dir - the directory in which the file was found, and name - the name of the file. 
//For example: java What JAC444 .java will print all the java files from the folder JAC444

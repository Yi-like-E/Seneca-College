...
function transformObservations(observations) {
  return observations.map(function (observation) {
    ...
    obj.date = new Date(observation.created_at);
    ...
    obj.photoUrl = observation.taxon.default_photo.square_url;
    obj.wikipediaUrl = observation.taxon.wikipedia_url;
    obj.isNative = Boolean(observation.taxon.native);
    obj.isIntroduced = Boolean(observation.taxon.introduced);
    obj.isEndangered = Boolean(observation.taxon.endangered);
    obj.isThreatened = Boolean(observation.taxon.threatened);
    return obj;
  });
}
